...
namespace LethalAPI.ProjectTemplate;
...
public class Plugin : LethalAPI.Core.Features.Plugin<Config>
{
    ...
    ///     This is optional. A custom implementation can replace this.
    /// </remarks>
    public static Harmony Harmony => new("com.LethalAPI.ProjectTemplate");

    /// <inheritdoc />
    public override string Name => "LethalAPI.ProjectTemplate";
    ...
    public override void OnEnabled()
    {
        ...
        Instance = this;
        Log.Info($"Started plugin &3LethalAPI.ProjectTemplate &gv1.0.0 &rby &7LethalAPI Modding Community&r.{(this.Config.Debug ? " [&2Debug&r]" : string.Empty)}");
    }
}